                        ...
                        >
                            <Popover.Panel className="absolute z-10 bg-black text-white text-sm w-36 p-2">
                                <div className="grid grid-cols-1 gap-y-1">
                                    <Link className="hover:text-slate-300" to="/contract-management/manage-contracts/contracts">Contracts</Link>
                                    <Link className="hover:text-slate-300" to="/contract-management/manage-contracts/contractors">Contractors</Link>
                                </div>
                            </Popover.Panel>
                        </Transition>
                    </>
